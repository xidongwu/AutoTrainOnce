...
CUDA_VISIBLE_DEVICES=2,3 nohup python -u main.py --arch resnet50 --workers 16 --stage train-gate --weight-decay 1e-4 --mix_up True --p 0.37 --batch-size 256 --lr 0.1 --cos_anneal True --gates 2 --epoch 245 --start_epoch_hyper 25 --start_epoch_gl 50 --lmd 10 --grad_mul 5 --reg_w 2.0 ../model_compress/Data/ILSVRC2012/ > rn50_lmd10_50_sgd.txt 2>&1 &
