...
# 0.559 -> p = 0.54
CUDA_VISIBLE_DEVICES=4,5,6,7 nohup python -u main.py --arch resnet34 --workers 16 --stage train-gate --weight-decay 5e-2 --mix_up True --p 0.54 --batch-size 512 --lr 1e-3 --opt_name ADAMW --gates 2 --epoch 245 --start_epoch_hyper 25 --start_epoch_gl 50 --lmd 0 --grad_mul 5 --reg_w 4.0 ../model_compress/Data/ILSVRC2012/ > rn34_lmd0_56_adam_cos_jitter_mixup.txt 2>&1 &